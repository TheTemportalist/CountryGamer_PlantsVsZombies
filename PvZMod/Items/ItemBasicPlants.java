...
public class ItemBasicPlants extends ItemBase
{
  public static final String[] itemMetaNames = { "sunflowerPlant", "peaShooterPlant", "snowPeaPlant", "repeaterPlant", "threePeaterPlant" };

  public static final String[] itemGameNames = { "Sunflower Plant", "Pea Shooter Plant", "Snow Pea Plant", "Repeater Plant", "Three-Peater Plant" };

  public static String base_Tex = PvZ_Main.base_Tex;
  public static final String[] item_a = { base_Tex + "Sunflower_Plant", base_Tex + "Pea_Shooter_Plant", base_Tex + "Snow_Pea_Plant", base_Tex + "Repeater_Plant", base_Tex + "Three_Peater_Plant" };

  @SideOnly(Side.CLIENT)
  private Icon[] item_b;
  public boolean onGround = true;

  public ItemBasicPlants(int id)
  {
    super(id);
    setHasSubtypes(true);
    setMaxDamage(0);
