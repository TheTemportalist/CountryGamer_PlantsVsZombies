...
import CountryGamer_PlantsVsZombies.PvZMod.Items.ItemGuideBook;

public class GuiGuide extends GuiScreen
{
  private static final ResourceLocation book = new ResourceLocation("countrygamer_plantsvszombies", "textures/gui/book1.png");

  private int bookImageWidth = 256;
  private int bookImageHeight = 256;
  private int page = 0; private int totalPage = 20;
  ...
  public void initGui()
  {
    ...
    this.buttonList.add(this.nextRecipeButtonIndex = new GuiButtonMerchant(1, i + this.bookImageWidth - 30, j + 190, true));
    this.buttonList.add(this.previousRecipeButtonIndex = new GuiButtonMerchant(2, i + 17, j + 190, false));
  ...
  public void drawScreen(int i, int j, float f) {
    ...
    byte b0 = 30;
    drawTexturedModalRect(k, b0, 0, 0, this.bookImageWidth, this.bookImageHeight);
    ...
    case 0:
      ...
      break;
    case 1:
      str = new String[] { "Crazy Dave's Plant Guide", "By: TheCountryGamer", "Mod Website:", "plantsvszombies-minecraft.com", "I hope you enjoy the mod!" };
    ...
    case 2:
      ...
      break;
    case 3:
      str = new String[] { "Getting Started", "(continued)", "Any Leaves BLOCK", "will give you 4", "Chlorophyll when", "CRAFTED. The Cactus", "BLOCK will give you", "5 Chlorophyll when", "CRAFTED." };
    ...
    case 4:
      ...
      break;
    case 5:
      str = new String[] { "Getting the Utilities", "(continued)", "Crazy Dave's Box", "Next up is Crazy Dave's Box. This box allows", "you to get the Tier 1 Plant(s), some Plant", "Food and the Recipes for Special Plants", "(All of these are described in the", "Greenhouse Section)." };
    ...
    case 7:
      ...
      break;
    case 8:
      str = new String[] { "Getting the Utilities", "(continued)", "After you place your Greenhouse, you can", "(right) click on the block to find this GUI:", "(insert picture)", "Here, you will find 1 input slot, 2 modifier", "slots, and 1 output slot (for now ;D). As of", "now, Plant Food and Special Recipes are NOT", "implemented." };
      ...
      break;
    case 9:
      str = new String[] { "Getting the Utilities", "(continued)", "To use the Greenhouse, first find your targeted", "output below. To get that output, you must", "put the appropriate; input item in the input", "(the slot with the pea shooter plant),", "modifier1 item in the modifier1 slot (the slot", "with the sunlight item), modifier2 item in the", "modifier2 slot (the slot with the snowball).", "Normally, each upgrade take approximately", "600 ticks (thats about 300 seconds)" };
      ...
      break;
    case 10:
      str = new String[] { "Getting Ready", "Alright. Cool. Now that you have at least the", "Pea Shooter plant (Tier 1: Day Faction), we", "can get ready to spawn him into the world.", "Assuming you have the PeaShooterPlant Item,", "we want to get the Grass that he needs to", "spawn on." };
    ...
    case 15:
      ...
      break;
    case 16:
      str = new String[] { "Getting Set", "(continued)", "you will get that Plant's Item back again.", "This way, if you accidentally place a", "plant where you didn't want it, you can", "re-plant that Plant!" };
      ...
      break;
    case 17:
      str = new String[] { "Additional Things", "Now, aside from the way to get the plants,", "we also have other items and blocks that", "you can have fun with!", "Pod Projectiles", "So you know how those plants shoot pea", "pods, well now you can too! There are Pea", "Pods, Snow Pods, Shroom Pods, and", "Creeper Pods. To shoot these, you must", "(right) click, and it will spawn the", "projectile, using it up." };
  ...
  private void string(String str, int x, int y) {
    this.fontRenderer.drawString(str, x, y, 0);
  }
}