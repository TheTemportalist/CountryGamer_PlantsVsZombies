...
public class PvZ_Main
{
  ...
  public static String endowedGrass_bottom_Tex = base_Tex + "endowedGrass_Bottom";
  ...
  public static String darkenedGrass_bottom_Tex = base_Tex + "darkenedGrass_Bottom";
  public static String darkenedGrass_side_Tex = base_Tex + "darkenedGrass_Side";
  ...
  public static String chlorophyllBowl_Filled_Tex = ":assets:" + base_Tex + "textures:blocks:bowlFilled.png";
  ...
  public static String chlorophyllLiquidStill_Tex = base_Tex + "Chlorophyll Still";
  public static String chlorophyllLiquidFlow_Tex = base_Tex + "Chlorophyll Flow";
  public static final Material chlorophyllMat = new MaterialLiquid(MapColor.waterColor);
  ...
  public static EnumArmorMaterial footballArmor = EnumHelper.addArmorMaterial("FOOTBALL_ARMOR", 12, new int[] { 1, 4, 3, 1 }, 0);
  public static CreativeTabs pvzTab;

  @Mod.EventHandler
  public void preInit(FMLPreInitializationEvent event) { String itemCate = "Item IDs"; String blockCate = "Block IDs";
    String liquidCate = "Liquid IDs"; String cropCate = "Crop IDs";
    String ids = "IDs";
    ...
    chlorophyllBowl_ID = config.get(blockCate, "Chlorophyll Bowl", 500).getInt();
    ...
    darkenedGrass_ID = config.get(blockCate, "Darkened Grass", 504).getInt();
    gravestone_ID[0] = config.get(blockCate, "Normal Gravestone", 505).getInt();
    gravestone_ID[1] = config.get(blockCate, "Regular Gravestone", 506).getInt();
    gravestone_ID[2] = config.get(blockCate, "Football Gravestone", 507).getInt();
    gravestone_ID[3] = config.get(blockCate, "Flag Gravestone", 508).getInt();
    gravestone_ID[4] = config.get(blockCate, "Cone Gravestone", 509).getInt();
    gravestone_ID[5] = config.get(blockCate, "Bucket Gravestone", 510).getInt();
    ...
    transTrowel_ID = config.get(itemCate, "Transplant Trowel", 528).getInt();
    ...
    footballLegs_ID = config.get(itemCate, "Football Leggings", 535).getInt();
    ...
    zombieSpawnDelay = config.get(general, "Minutes in between waves of zombies. (Whole numbers only!)", 10).getInt();
  ...
  public void init(FMLInitializationEvent event) {
    ...
    pvzTab = new CreativeTabs("pvzTab") { public ItemStack getIconItemStack() { return new ItemStack(PvZ_Main.sunlight, 1, 0);
      }
    };
    LanguageRegistry.instance().addStringLocalization("itemGroup.pvzTab", "en_US", "Plants Vs Zombies");
    ...
    empower = new PotionEmpower(32, false, 0).setPotionName("potion.empower");
    LanguageRegistry.instance().addStringLocalization("potion.empower", "Empower");
  ...
  public void items()
  {
    chlorophyll = new ItemChlorophyll(chlorophyll_ID).setUnlocalizedName("Chlorophyll");
    ...
    moonlight = new ItemMoonlight(moonlight_ID).setUnlocalizedName("moonlight");
    ...
    transTrowel = new ItemTransTrowel(transTrowel_ID).setUnlocalizedName("transTrowel");
    LanguageRegistry.addName(transTrowel, "Transplant Trowel");

    basicPlants = new ItemBasicPlants(basicPlants_ID).setUnlocalizedName("basicPlants");
    ...
    for (int i = 0; i < cropCodeNames.length; i++) {
      LanguageRegistry.instance().addStringLocalization("item.basicPlants." + cropCodeNames[i] + ".name", cropGameNames[i]);
    }

    nightPlants = new ItemNightPlants(nightPlants_ID).setUnlocalizedName("nightPlants");

    cropCodeNames = ItemNightPlants.itemMetaNames;
    cropGameNames = ItemNightPlants.itemGameNames;
    for (int i = 0; i < cropCodeNames.length; i++) {
      LanguageRegistry.instance().addStringLocalization("item.nightPlants." + cropCodeNames[i] + ".name", cropGameNames[i]);
    }
    ...
    shroomPod = new ItemShroomPod(shroomPod_ID).setUnlocalizedName("shroomPod");
    LanguageRegistry.addName(shroomPod, "Shroom Pod");
  }

  public void armor()
  {
    footballHelm = new ItemFootballHelm(footballHelm_ID, footballArmor, ModLoader.addArmor("football"), 0).setUnlocalizedName("football_helmet");

    LanguageRegistry.addName(footballHelm, "Football Helmet");
    footballHelm.setCreativeTab(pvzTab);
    footballChest = new ItemFootballChest(footballChest_ID, footballArmor, ModLoader.addArmor("football"), 1).setUnlocalizedName("football_chest");

    LanguageRegistry.addName(footballChest, "Football Chest");
    footballChest.setCreativeTab(pvzTab);
    footballLegs = new ItemFootballLegs(footballLegs_ID, footballArmor, ModLoader.addArmor("football"), 2).setUnlocalizedName("football_legs");

    LanguageRegistry.addName(footballLegs, "Football Legs");
    footballLegs.setCreativeTab(pvzTab);
    footballBoots = new ItemFootballBoots(footballBoots_ID, footballArmor, ModLoader.addArmor("football"), 3).setUnlocalizedName("football_boots");
  ...
  {
    liquids();
    endowedGrass = new BlockEndowedGrass(endowedGrass_ID, Material.grass).setHardness(0.6F).setStepSound(Block.soundGrassFootstep).setUnlocalizedName("endowedGrass");

    GameRegistry.registerBlock(endowedGrass, "CountryGamer_PlantsVsZombiesendowedGrass");
    LanguageRegistry.addName(endowedGrass, "Endowed Grass");
    endowedGrass.setCreativeTab(pvzTab);

    darkenedGrass = new BlockDarkenedGrass(darkenedGrass_ID, Material.grass).setHardness(0.6F).setStepSound(Block.soundGrassFootstep).setUnlocalizedName("darkenedGrass");

    GameRegistry.registerBlock(darkenedGrass, "CountryGamer_PlantsVsZombiesdarkenedGrass");
    LanguageRegistry.addName(darkenedGrass, "Darkened Grass");
    darkenedGrass.setCreativeTab(pvzTab);

    GameRegistry.registerTileEntity(TileEntityChlorophyllBowl.class, "Chlorophyll Bowl");
    chlorophyllBowl = new BlockChlorophyllBowl(chlorophyllBowl_ID, TileEntityChlorophyllBowl.class).setHardness(0.2F).setResistance(3.0F).setUnlocalizedName("chlorophyllBowl");
    ...
    GameRegistry.registerTileEntity(TileEntityDave.class, "Crazy Dave's Box");
    seedBox = new BlockDave(seedBox_ID, TileEntityDave.class).setHardness(2.5F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("seedBox");
    ...
    greenhouse = new BlockGreenhouse(greenhouse_ID, TileEntityGreenhouse.class).setHardness(0.2F).setResistance(3.0F).setUnlocalizedName("greenhouse");
  ...
  public void gravestones() {
    ...
    gravestone = new BlockGravestone(gravestone_ID[0], 0, TileEntityGravestone.class).setUnlocalizedName("gravestone");

    GameRegistry.registerBlock(gravestone, "gravestone");
    LanguageRegistry.addName(gravestone, "Zombie Gravestone");

    gravestoneReg = new BlockGravestone(gravestone_ID[1], 1, TileEntityGravestone.class).setUnlocalizedName("gravestoneReg");

    GameRegistry.registerBlock(gravestoneReg, "gravestoneReg");
    LanguageRegistry.addName(gravestoneReg, "Regular Zombie Gravestone");

    gravestoneFootball = new BlockGravestone(gravestone_ID[2], 2, TileEntityGravestone.class).setUnlocalizedName("gravestoneFootball");

    GameRegistry.registerBlock(gravestoneFootball, "gravestoneFootball");
    LanguageRegistry.addName(gravestoneFootball, "Football Zombie Gravestone");

    gravestoneFlag = new BlockGravestone(gravestone_ID[3], 3, TileEntityGravestone.class).setUnlocalizedName("gravestoneFlag");

    GameRegistry.registerBlock(gravestoneFlag, "gravestoneFlag");
    LanguageRegistry.addName(gravestoneFlag, "Flag Zombie Gravestone");

    gravestoneCone = new BlockGravestone(gravestone_ID[4], 4, TileEntityGravestone.class).setUnlocalizedName("gravestoneCone");

    GameRegistry.registerBlock(gravestoneCone, "gravestoneCone");
    LanguageRegistry.addName(gravestoneCone, "Cone Zombie Gravestone");

    gravestoneBucket = new BlockGravestone(gravestone_ID[5], 5, TileEntityGravestone.class).setUnlocalizedName("gravestoneBucket");
  ...
  public void gravestoneCraft() {
    GameRegistry.addRecipe(new ItemStack(gravestoneReg, 1), new Object[] { "xxx", "xcx", "xxx", Character.valueOf('c'), gravestone, Character.valueOf('x'), Item.rottenFlesh });
    ...
    GameRegistry.addShapelessRecipe(new ItemStack(gravestoneBucket, 1), new Object[] { gravestone, Item.bucketEmpty });

    GameRegistry.addRecipe(new ItemStack(gravestone, 1), new Object[] { "xx", "cc", "vv", Character.valueOf('x'), Block.stone, Character.valueOf('c'), darkenedGrass, Character.valueOf('v'), Item.rottenFlesh });
  }
  ...
  public void entities() {
    int throwEntityID = 5;
    throwEntityID++; EntityRegistry.registerModEntity(EntityPeaPod.class, "Pea Pod", throwEntityID, this, 64, 1, true);
    RenderingRegistry.registerEntityRenderingHandler(EntityPeaPod.class, new RenderSnowball(peaPod));

    throwEntityID++; EntityRegistry.registerModEntity(EntitySnowPod.class, "Snow Pod", throwEntityID, this, 64, 1, true);
    RenderingRegistry.registerEntityRenderingHandler(EntitySnowPod.class, new RenderSnowball(snowPod));

    throwEntityID++; EntityRegistry.registerModEntity(EntitySunlight.class, "Sunlight", throwEntityID, this, 64, 1, true);
    RenderingRegistry.registerEntityRenderingHandler(EntitySunlight.class, new RenderSnowball(sunlight));

    throwEntityID++; EntityRegistry.registerModEntity(EntityMoonlight.class, "Moonlight", throwEntityID, this, 64, 1, true);
    RenderingRegistry.registerEntityRenderingHandler(EntityMoonlight.class, new RenderSnowball(moonlight));

    throwEntityID++; EntityRegistry.registerModEntity(EntityShroomPod.class, "Shroom Pod", throwEntityID, this, 64, 1, true);
    RenderingRegistry.registerEntityRenderingHandler(EntityShroomPod.class, new RenderSnowball(shroomPod));

    throwEntityID++; EntityRegistry.registerModEntity(EntityCreeperPod.class, "Creeper Pod", throwEntityID, this, 64, 1, true);
    RenderingRegistry.registerEntityRenderingHandler(EntityCreeperPod.class, new RenderSnowball(creeperPod));

    EntDec.mobEnts();
  }

  public void crafting() {
    GameRegistry.addRecipe(new ItemStack(peaPod, 1), new Object[] { " x ", "xxx", " x ", Character.valueOf('x'), chlorophyll });

    GameRegistry.addRecipe(new ItemStack(snowPod, 1), new Object[] { " x ", "xcx", " x ", Character.valueOf('x'), chlorophyll, Character.valueOf('c'), Item.snowball });

    GameRegistry.addRecipe(new ItemStack(shroomPod, 1), new Object[] { " x ", "xcx", " x ", Character.valueOf('x'), chlorophyll, Character.valueOf('c'), moonlight });

    GameRegistry.addRecipe(new ItemStack(chlorophyllBowl, 1), new Object[] { " x ", "xcx", " x ", Character.valueOf('x'), chlorophyll, Character.valueOf('c'), Item.bowlEmpty });

    Object[] chloIngred = { Block.tallGrass, Block.leaves, Item.seeds, Item.carrot, Item.potato, Block.cactus };

    int[] chloResult = { 3, 4, 2, 2, 2, 5 };

    if (chloIngred.length == chloResult.length) {
      for (int i = 0; i < chloIngred.length; i++) {
        GameRegistry.addShapelessRecipe(new ItemStack(chlorophyll, chloResult[i]), new Object[] { chloIngred[i] });
      }
    }
    else
    {
    ...
    GameRegistry.addRecipe(new ItemStack(trowel, 1), new Object[] { " x ", "xxx", " c ", Character.valueOf('x'), Item.ingotIron, Character.valueOf('c'), Item.stick });

    GameRegistry.addShapelessRecipe(new ItemStack(transTrowel, 1), new Object[] { trowel, sunlight });

    GameRegistry.addRecipe(new ItemStack(greenhouse, 1), new Object[] { "xxx", "x x", "vcv", Character.valueOf('x'), Block.thinGlass, Character.valueOf('v'), Block.cobblestone, Character.valueOf('c'), Block.dirt });
  }
}