...
public class TileEntityGravestone extends TileEntity
{
  ...
  public void updateEntity()
  {
    ...
    if (!getWorldObj().isRemote) {
      ...
      List entList = getWorldObj().getEntitiesWithinAABB(entity.getClass(), AxisAlignedBB.getAABBPool().getAABB(this.xCoord - 3.0D, this.yCoord, this.zCoord - 3.0D, this.xCoord + 3.0D, this.yCoord, this.zCoord + 3.0D));
      ...
      PvZ_Util.spawnRandZombie(this.worldObj, this.xCoord, this.yCoord, this.zCoord, this.facing, this.type);
