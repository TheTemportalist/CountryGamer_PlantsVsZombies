...
public class EntityThreePeater extends EntityPlantShooterBase
{
  ...
  {
    super(par1World, new ItemStack(PvZ_Main.basicPlants, 1, 4));

    setTexture("/mods/CountryGamer_PlantsVsZombies/textures/mobs/ThreePeater.png");
  }

  protected void dropFewItems(boolean par1, int par2) {
    dropItem(PvZ_Main.peaPod.itemID, 3);
  }
  ...
  public void attackEntityWithRangedAttack(EntityLivingBase entitylivingbase, float f)
  {
    ...
    int[] facingA = PvZ_Util.entityDirectionSpawn(this);
    EntityThrowable ent2;
    EntityThrowable ent3;
    switch (PvZ_Util.entityDirection(this)) {
    case 0:
      ent2 = new EntityPeaPod(this.worldObj, this, this.posX + facingA[0], this.posY, this.posZ);

      ent3 = new EntityPeaPod(this.worldObj, this, this.posX + facingA[1], this.posY, this.posZ);

      break;
    case 1:
      ent2 = new EntityPeaPod(this.worldObj, this, this.posX, this.posY, this.posZ + facingA[0]);

      ent3 = new EntityPeaPod(this.worldObj, this, this.posX, this.posY, this.posZ + facingA[1]);
    ...
    case 3:
      ...
      break;
    default:
      ent2 = new EntityPeaPod(this.worldObj, this, this.posX, this.posY, this.posZ);

      ent3 = new EntityPeaPod(this.worldObj, this, this.posX, this.posY, this.posZ);
    }

    double toX = entitylivingbase.posX - this.posX;
    float percentToMouth = 0.5F;
    double toY = entitylivingbase.posY + this.height * percentToMouth - 1.0D - ent1.posY;
    ...
    ent2.setThrowableHeading(toX + podOffset, toY + f1, toZ + podOffset, 1.6F, 12.0F);
    ent3.setThrowableHeading(toX - podOffset, toY + f1, toZ - podOffset, 1.6F, 12.0F);
    ...
    PvZ_Util.entityDirectionSpawn(this);
  }
}